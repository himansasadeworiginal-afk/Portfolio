      ...
      <main>
        ...
        <SectionWrapper id="hero" className="relative min-h-screen flex items-center justify-center bg-bg-primary overflow-hidden">
          ...
          <div
            ...
            style={{
              zIndex: 2,
              filter: "brightness(1.5) sepia(1) saturate(3) hue-rotate(5deg)",
            }}
          >
            <svg
              viewBox="0 0 512 512"
              className="w-[70vh] h-[70vh] opacity-[0.06]"
              fill="none"
            ...
            >
              <g id="hero-wolf">
                ...
                <path d="M160 160 L120 140 L140 180 M352 160 L392 140 L372 180 M120 260 L90 250 L110 290 M392 260 L422 250 L402 290" stroke="#D4AF37" strokeWidth="1" opacity="0.6" />
                <path d="M220 360 L200 390 M292 360 L312 390" stroke="#D4AF37" strokeWidth="1.5" />
              </g>
            </svg>
          </div>
        ...
        <SectionWrapper id="contact" className="py-24 bg-bg-surface relative overflow-hidden">
          ...
          >
            <svg
              viewBox="0 0 512 512"
              className="h-full max-h-[600px] w-auto opacity-[0.04]"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <g id="contact-wolf">
